			...
			<main className="py-6 px-4 sm:p-6 md:py-10 md:px-8 bg-slate-100 min-h-[100dvh]">
				...
				<div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
					...
					<p className="mt-4 text-l leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-800">
						...
						States, affecting 40 million adults in the United States age 18 and
						older, or 18.1% of the population every year. Anxiety disorders are
						highly treatable, yet only 36.9% of those suffering receive
						treatment.
						<br />
						<br />
						Symptoms of anxiety disorders <br />
						The symptoms of anxiety disorders can vary from person to person,
						but they often include: <br />
						<br />
				...
				<div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
					...
					<p className="mt-4 text-l leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-800">
						...
						<br />
						<br />
						1. Hallucinations: These are experiences that seem real but are not
						actually there. For example, a person with schizophrenia might hear
						voices or see things that are not there. <br />
						<br />
						2. Delusions: These are false beliefs that a person holds onto even
						when there is evidence to the contrary. For example, a person with
						schizophrenia might believe that they are being persecuted or that
						they have special powers. <br />
						<br />
						3. Disorganized thinking and speech: This can make it difficult for
						people with schizophrenia to communicate effectively. They may speak
						in a rapid or incoherent way, or they may have trouble staying on
						topic. <br />
						<br />
						...
						show a lack of motivation, interest, or pleasure in activities that
				...
				<div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
					...
					<p className="mt-4 text-l leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-800">
						...
						highs (mania or hypomania) and lows (depression). These mood swings
						can affect sleep, energy, activity levels, judgment, behavior, and
						the ability to think clearly.
						<br />
						<br />
						People with bipolar disorder can experience both manic and
						depressive episodes, but not everyone will experience both types of
						episodes. Some people may only experience manic or depressive
				...
				<div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
					...
					<p className="mt-4 text-l leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-800">
						...
						body's immune system attacks and destroys the cells in your pancreas
						that produce insulin. Insulin is a hormone that helps your body use
						glucose for energy. Without insulin, glucose builds up in your
						blood, causing high blood sugar levels. Type 1 diabetes is typically
						diagnosed in children and young adults, but it can occur at any age.
						<br />
						<br />
						Type 2 diabetes is the most common type of diabetes. It occurs when
						your body doesn't produce enough insulin or doesn't use insulin
						effectively. This can cause high blood sugar levels. Type 2 diabetes
						is often linked to lifestyle factors such as obesity and inactivity.
						<br />
						<br />
						Gestational diabetes: This type of diabetes develops during
						pregnancy. It typically goes away after the baby is born, but women
						with gestational diabetes are at an increased risk of developing
						type 2 diabetes later in life.
						<br />
						<br />
						Other types of diabetes: There are a number of other less common
						types of diabetes, including maturity-onset diabetes of the young
						(MODY), secondary diabetes, and cystic fibrosis-related diabetes.
					</p>
				</div>
				...
				<div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
					...
					<p className="mt-4 text-l leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-800">
						...
						exerted by the circulating blood upon the walls of blood vessels. If
						left untreated, hypertension can lead to a number of serious
						...
						often has no symptoms. However, some people with hypertension may
				...
				<div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
					...
					<p className="mt-4 text-l leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-800">
						...
						that enables nearly frictionless joint motion. With OA, the
						cartilage wears down, causing the bones to rub together, which can
						...
						vary from person to person. Some of the most common symptoms of OA
						include:
						<br />
						<br />
						1. Pain: Pain is the most common symptom of OA and is typically felt
						in the affected joint. The pain may be worse during activity and
						improve with rest.
						<br />
						<br />
						...
						<br />
						<br />
						4. Reduced range of motion: As OA progresses, the range of motion in
						the affected joint may decrease. This can make it difficult to
				...
				<div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
					...
					<p className="mt-4 text-l leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-4 lg:col-span-1 dark:text-slate-800">
						...
						for air to flow in and out of the lungs, leading to symptoms such as
						...
						<br />
						<br />
						The symptoms of asthma can vary from person to person and can range
						from mild to severe. Some of the most common symptoms of asthma
						include:
						<br />
						<br />
