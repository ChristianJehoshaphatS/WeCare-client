...
const LandingPage = () => {
	return (
		<>
			<main className="flex flex-col justify-center py-6 px-4 sm:p-6 md:py-10 md:px-8 bg-slate-100 min-h-[100dvh]">
				<div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
					<div className="relative p-3 col-start-1 row-start-1 flex flex-col-reverse rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1">
						...
						<h1 className="text-4xl leading-4 font-medium text-white dark:sm:text-slate-800 my-4 sm:block hidden">
							Welcome to WeCare
						</h1>
						<h1 className="text-4xl leading-4 font-medium text-white dark:sm:text-slate-800 my-4 sm:hidden">
							WeCare
						</h1>
					</div>
					...
					<div className="mt-4 col-start-1 row-start-3 self-center sm:mt-0 sm:col-start-2 sm:row-start-2 sm:row-span-2 lg:mt-6 lg:col-start-1 lg:row-start-3 lg:row-end-4">
						<Link to="/login">
							<button
								type="button"
								className="bg-[#2596be] text-white text-sm leading-6 font-medium py-2 px-3 rounded-lg"
							>
								Connect
							</button>
						</Link>
